...
export function LinkParcelForm({ listingId, parcelId }: { listingId: number; parcelId: number | null }) {
  ...
  if (parcelId) return <div className="card" style={{ padding: 14, marginTop: 16, background: "#effaf3", borderColor: "#b9e6c9" }}><strong>Linked parcel #{parcelId}</strong><small style={{ display: "block", marginTop: 4, color: "#4c6656" }}>Spatial analysis and zoning context are attached to this listing.</small></div>;
