...
export default async function Home() {
  ...
  const metrics = [
    ["Pipeline value", `R ${dashboard.pipelineValue.toLocaleString("en-ZA")}`, `${dashboard.reportCount} feasibility reports`, "blue"],
